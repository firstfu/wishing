    ...
    <div className="container mx-auto py-12 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-5xl font-bold mb-6">關於我們</h1>
        ...
        {/* 我們的價值觀 */}
        <div className="mb-16">
          <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">我們的價值觀</h2>
        ...
        {/* 團隊成員 */}
        <div className="mb-16">
          <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">認識我們的團隊</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* 團隊成員1 */}
            <div className="bg-card border border-border rounded-xl overflow-hidden">
              <div className="h-48 bg-muted"></div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-1">陳小明</h3>
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
              <div className="h-48 bg-muted"></div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-1">林美玲</h3>
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
              <div className="h-48 bg-muted"></div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-1">王大偉</h3>
        ...
        <div className="bg-card border border-border rounded-xl p-8 md:p-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-lg bg-background border border-border flex flex-col items-center text-center">
