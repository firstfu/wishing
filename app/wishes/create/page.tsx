// ====================================================================
// wishes/create/page.tsx - 許願池發布新願望頁面
//
// 提供用戶創建新願望的表單介面，包含標題、描述、價格和分類等欄位。
// 支援表單驗證功能，確保用戶提交的願望數據符合要求。
// 使用 Server Component 獲取分類數據，並通過 Client Component 處理表單提交。
// 實現用戶友好的錯誤提示和載入狀態，提升表單填寫體驗。
// 成功提交後自動導向至新建願望的詳情頁面。
// 頁面包含視覺化裝飾和提示信息，幫助用戶理解如何撰寫有效的願望。
// ====================================================================
// 作用：提供表單讓用戶創建新的許願
// 功能：
// - 頂部橫幅展示頁面說明
