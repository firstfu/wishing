// about/privacy/page.tsx - 許願池隱私政策頁面
//
// 提供許願池平台完整的隱私政策內容，清晰說明如何收集、使用和保護用戶資料。
// 頁面以結構化方式展示政策內容，包含資訊收集、使用方式、共享、安全措施等章節。
// 使用編號標記和視覺分隔，提升閱讀體驗，使用戶能清楚了解其隱私權益。
// 包含聯絡資訊，便於用戶提出隱私相關的問題或請求。
// 設計包含簡潔的背景裝飾和適當的視覺層次，確保內容易於閱讀和理解。
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="absolute inset-0 overflow-hidden -z-10">
        <div className="absolute top-[10%] right-[8%] w-72 h-72 rounded-full bg-primary/5 animate-pulse-slow"></div>
        <div className="absolute bottom-[25%] left-[7%] w-64 h-64 rounded-full bg-secondary/5 animate-pulse-slow animation-delay-600"></div>
        <div className="absolute inset-0 bg-pattern-dots opacity-30"></div>
      </div>

      <div className="container mx-auto py-12 px-4 relative z-10">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">隱私政策</h1>
          ...
          <div className="prose prose-lg max-w-none bg-card border border-border p-8 rounded-xl shadow-sm animate-fade-in">
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3 text-primary/90">1.1 您提供的資訊</h3>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3 text-primary/90">1.2 自動收集的資訊</h3>
            <ul className="list-disc pl-6 mb-6 space-y-2">
              <li>
