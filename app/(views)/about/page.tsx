// about/page.tsx - 許願池「關於我們」頁面
//
// 提供許願池平台的綜合介紹，包含使命、願景、價值觀和團隊資訊。
// 使用視覺化的卡片、圖示和動畫效果，提高頁面的吸引力和互動性。
// 包含「我們的使命」、「我們的願景」、「我們的價值觀」和「我們的團隊」等分區。
// 頁面底部提供聯絡資訊和連結到更詳細的「我們的故事」、「使用條款」和「隱私政策」頁面。
// 設計包含多種動畫效果和響應式佈局，確保在各種裝置上的最佳顯示效果。
